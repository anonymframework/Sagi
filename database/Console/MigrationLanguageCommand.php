 ...
 */
class MigrationLanguageCommand extends Command
{

    protected function configure()
    {
        $this->setName('migration:language')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!file_exists($fileName)) {
            ...
            if (touch($fileName)) {
                $put = file_put_contents($fileName, $content = TemplateManager::prepareContent('language', []));
